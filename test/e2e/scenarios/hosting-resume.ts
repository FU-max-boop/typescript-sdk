...
export async function hostingResumeEventIds(_args: TestArgs) {
...
export async function hostingResumeReplay(_args: TestArgs) {
    const eventStore = new InMemoryEventStore();
...
export async function hostingResumeBufferedReplay(_args: TestArgs) {
    const eventStore = new InMemoryEventStore();
...
export async function hostingResumeBadEventId(_args: TestArgs) {
...
export async function hostingResumePriming(_args: TestArgs) {
    const RETRY_MS = 7331;
    const eventStore = new InMemoryEventStore();
...
export async function hostingResumeStreamScoped(_args: TestArgs) {
    const eventStore = new InMemoryEventStore();
...
export async function hostingResumeCloseStream(_args: TestArgs) {
    const eventStore = new InMemoryEventStore();
