...
export async function promptsCapabilityDeclared({ transport }: TestArgs) {
...
export async function promptsListBasic({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        s.registerPrompt('summarize', { description: 'Summarize the provided text.', argsSchema: { text: z.string() } }, ({ text }) => ({
            messages: [{ role: 'user', content: { type: 'text', text: `Summarize the following text:\n${text}` } }]
...
export async function promptsListPagination({ transport }: TestArgs) {
    const TOTAL = 25;
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function promptsListPaginationRaw({ transport }: TestArgs) {
    const TOTAL = 25;
    const PAGE = 10;
...
export async function promptsListChanged({ transport }: TestArgs) {
...
export async function promptsGetNoArgs({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, explainCommitServer, client);
...
export async function promptsGetWithArgs({ transport }: TestArgs) {
    const client = newClient();
...
export async function promptsGetMissingRequiredArgs({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, summarizeServer, client);
...
export async function promptsGetUnknownName({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, explainCommitServer, client);
...
export async function promptsGetContentImage({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function promptsGetContentAudio({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function promptsGetContentEmbeddedResource({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function mcpserverPromptArgsValidation({ transport }: TestArgs) {
...
export async function mcpserverPromptOptionalArgs({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function mcpserverPromptDuplicateName({ transport }: TestArgs) {
...
export async function mcpserverPromptHandleUpdateRemove({ transport }: TestArgs) {
...
export async function mcpserverPromptLegacyOverload({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
