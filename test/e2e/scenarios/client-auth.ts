...
export async function clientAuth401TriggersFlow(_args: TestArgs) {
...
export async function clientAuth401AfterAuthThrows(_args: TestArgs) {
    const as = createMockAuthorizationServer({
...
export async function clientAuth403ScopeUpgrade(_args: TestArgs) {
...
export async function clientAuthAsMetadataDiscoveryPriorityOrder(_args: TestArgs) {
...
export async function clientAuthBearerHeaderEveryRequest(_args: TestArgs) {
...
export async function clientAuthCimd(_args: TestArgs) {
...
export async function clientAuthClientCredentials(_args: TestArgs) {
...
export async function clientAuthDcr(_args: TestArgs) {
    const as = createMockAuthorizationServer();
    const provider = new RecordingOAuthClientProvider();
...
export async function clientAuthInvalidClientClearsAll(_args: TestArgs) {
...
export async function clientAuthInvalidGrantClearsTokens(_args: TestArgs) {
    const as = createMockAuthorizationServer({
...
export async function clientAuthPkceRefuseIfUnsupported(_args: TestArgs) {
...
export async function clientAuthPkceS256(_args: TestArgs) {
...
export async function clientAuthPreRegistration(_args: TestArgs) {
...
export async function clientAuthPrivateKeyJwt(_args: TestArgs) {
...
export async function clientAuthPrmDiscoveryFallbackOrder(_args: TestArgs) {
    const discoveryCalls: string[] = [];
...
export async function clientAuthPrmResourceMismatch(_args: TestArgs) {
...
export async function clientAuthResourceParameter(_args: TestArgs) {
...
export async function clientAuthScopeSelectionPriority(_args: TestArgs) {
...
export async function clientAuthStateVerify(_args: TestArgs) {
    const as = createMockAuthorizationServer();
...
export async function clientAuthTokenEndpointAuthMethod(_args: TestArgs) {
...
export async function clientAuthLowLevelDiscoverAndExchange(_args: TestArgs) {
    const as = createMockAuthorizationServer({
...
export async function clientAuthPrivateKeyJwtStaticAssertion(_args: TestArgs) {
...
export async function clientMiddlewareCompose(_args: TestArgs) {
...
export async function clientMiddlewareWithLogging(_args: TestArgs) {
...
export async function clientAuthMiddlewareWithOauth(_args: TestArgs) {
