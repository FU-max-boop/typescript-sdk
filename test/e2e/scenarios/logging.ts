...
export async function loggingCapabilityDeclared({ transport }: TestArgs) {
...
export async function loggingMessageFields({ transport }: TestArgs) {
...
export async function loggingMessageFiltered({ transport }: TestArgs) {
...
export async function loggingSetLevelInvalidLevel({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, loggingServer, client);
...
export async function loggingSetLevelInvalidLevelRaw({ transport }: TestArgs) {
...
export async function loggingOutOfBandBasic({ transport }: TestArgs) {
