...
export async function samplingCapabilityDeclare({ transport }: TestArgs) {
...
export async function samplingCreateBasic({ transport }: TestArgs) {
    const received: CreateMessageRequest[] = [];
...
export async function samplingCreateIncludeContext({ transport }: TestArgs) {
    const received: CreateMessageRequest[] = [];
    const client = newClient();
    client.setRequestHandler(CreateMessageRequestSchema, async req => {
        received.push(req);
...
export async function samplingCreateModelPreferences({ transport }: TestArgs) {
    const received: CreateMessageRequest[] = [];
    const client = newClient();
    client.setRequestHandler(CreateMessageRequestSchema, async req => {
        received.push(req);
...
export async function samplingCreateSystemPrompt({ transport }: TestArgs) {
    const received: CreateMessageRequest[] = [];
    const client = newClient();
    client.setRequestHandler(CreateMessageRequestSchema, async req => {
        received.push(req);
...
export async function samplingCreateTools({ transport }: TestArgs) {
    const received: CreateMessageRequest[] = [];
...
export async function samplingErrorUserRejected({ transport }: TestArgs) {
    const client = newClient();
...
export async function samplingMessageContentCardinality({ transport }: TestArgs) {
    const received: CreateMessageRequest[] = [];
    const client = newClient();
    client.setRequestHandler(CreateMessageRequestSchema, async req => {
        received.push(req);
...
export async function samplingResultNoToolsSingleContent({ transport }: TestArgs) {
    const client = newClient();
...
export async function samplingResultWithToolsArrayContent({ transport }: TestArgs) {
    const client = newClient({ sampling: { tools: {} } });
    client.setRequestHandler(CreateMessageRequestSchema, async () => {
        return {
            model: 'm',
...
export async function samplingToolResultNoMixedContent({ transport }: TestArgs) {
    const client = newClient();
    client.setRequestHandler(CreateMessageRequestSchema, async () => {
...
export async function samplingToolUseResultBalance({ transport }: TestArgs) {
    const received: CreateMessageRequest[] = [];
    const client = newClient({ sampling: { tools: {} } });
    client.setRequestHandler(CreateMessageRequestSchema, async req => {
        received.push(req);
...
export async function samplingToolsServerGatedByCapability({ transport }: TestArgs) {
    const received: CreateMessageRequest[] = [];
    const client = newClient({ sampling: {} });
    client.setRequestHandler(CreateMessageRequestSchema, async req => {
        received.push(req);
