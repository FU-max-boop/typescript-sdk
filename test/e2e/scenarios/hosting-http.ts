...
export async function hostingHttpAccept406(_args: TestArgs) {
...
export async function hostingHttpBatch(_args: TestArgs) {
...
export async function hostingHttpContentType415(_args: TestArgs) {
    const { handleRequest, close } = hostStateless(echoServer);
...
export async function hostingHttpDisconnectNotCancel(_args: TestArgs) {
...
export async function hostingHttpDnsRebinding(_args: TestArgs) {
...
export async function hostingHttpJsonResponseMode(_args: TestArgs) {
    const makeServer = () => echoServer();
...
export async function hostingHttpMethod405(_args: TestArgs) {
...
export async function hostingHttpNoBroadcast(_args: TestArgs) {
...
export async function hostingHttpNotifications202(_args: TestArgs) {
    const { handleRequest, close } = hostPerSession(echoServer);
...
export async function hostingHttpOnerror(_args: TestArgs) {
    const errors: Error[] = [];
    const tx = new WebStandardStreamableHTTPServerTransport({ sessionIdGenerator: randomUUID });
...
export async function hostingHttpParseError400(_args: TestArgs) {
    const { handleRequest, close } = hostStateless(echoServer);
...
export async function hostingHttpProtocolVersion400(_args: TestArgs) {
    const { handleRequest, close } = hostPerSession(echoServer);
...
export async function hostingHttpResponseSameConnection(_args: TestArgs) {
    const { handleRequest, close } = hostPerSession(echoServer);
...
export async function hostingHttpSecondSseRejected(_args: TestArgs) {
    const { handleRequest, close } = hostPerSession(echoServer);
...
export async function hostingHttpSseCloseAfterResponse(_args: TestArgs) {
    const { handleRequest, close } = hostPerSession(echoServer);
...
export async function hostingHttpStandaloneSse(_args: TestArgs) {
    const makeServer = () => {
...
export async function hostingHttpStandaloneSseNoResponse(_args: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' }, { capabilities: { logging: {} } });
        return s;
    };
...
export async function hostingHttpSendNoListenerNoop(_args: TestArgs) {
    let server!: McpServer;
    const makeServer = () => {
        server = new McpServer({ name: 's', version: '0' }, { capabilities: { logging: {} } });
        return server;
