...
export async function completionCapabilityDeclared({ transport }: TestArgs) {
...
export async function completionContextArguments({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        s.registerResource(
            'github-repo',
...
export async function completionErrorInvalidRef({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, colorCompletionServer, client);
...
export async function completionErrorInvalidRefRaw({ transport }: TestArgs) {
    const makeServer = () => {
...
export async function completionPromptArg({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, colorCompletionServer, client);
...
export async function completionResourceTemplateArg({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        s.registerResource(
            'file-path',
...
export async function completionResultShape({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        s.registerPrompt(
            'complete-color',
...
export async function mcpserverCompletionCapabilityAuto({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function mcpserverCompletionCapabilityAutoRaw({ transport }: TestArgs) {
    const makeServer = () => {
