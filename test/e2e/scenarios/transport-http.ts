...
export async function clientTransportHttpSessionStored(_args: TestArgs) {
...
export async function clientTransportHttpProtocolVersionStored(_args: TestArgs) {
    const records: RecordedRequest[] = [];
    const handle = hostPerSession(() => echoServer());
...
export async function clientTransportHttpProtocolVersionHeader(_args: TestArgs) {
    const records: RecordedRequest[] = [];
...
export async function clientTransportHttpAcceptHeaderGet(_args: TestArgs) {
    const records: RecordedRequest[] = [];
    const handle = hostPerSession(() => echoServer());
...
export async function clientTransportHttpAcceptHeaderPost(_args: TestArgs) {
    const records: RecordedRequest[] = [];
    const handle = hostPerSession(() => echoServer());
...
export async function clientTransportHttpCustomHeaders(_args: TestArgs) {
    const records: RecordedRequest[] = [];
    const handle = hostPerSession(() => echoServer());
...
export async function clientTransportHttpCustomFetch(_args: TestArgs) {
...
export async function clientTransportHttpJsonResponseParsed(_args: TestArgs) {
...
export async function clientTransportHttp404Surfaces(_args: TestArgs) {
    const handle = hostPerSession(() => echoServer());
...
export async function clientTransportHttpTerminate405Ok(_args: TestArgs) {
    const handle = hostPerSession(() => echoServer());
...
export async function clientTransportHttpSse405Tolerated(_args: TestArgs) {
    const handle = hostPerSession(() => echoServer());
...
export async function clientTransportHttpNoReconnectAfterClose(_args: TestArgs) {
    const records: RecordedRequest[] = [];
...
export async function clientTransportHttpConcurrentStreams(_args: TestArgs) {
...
export async function clientTransportHttpNoReconnectAfterResponse(_args: TestArgs) {
    const records: RecordedRequest[] = [];
    const tokens: string[] = [];
...
export async function clientTransportHttpReconnectRetryValue(_args: TestArgs) {
    const RETRY_MS = 100;
    const encoder = new TextEncoder();
    const handle = hostPerSession(() => echoServer());
    const url = new URL('http://in-process/mcp');
...
export async function clientTransportHttpReconnectGet(_args: TestArgs) {
    const records: RecordedRequest[] = [];
...
export async function clientTransportHttpReconnectPostPriming(_args: TestArgs) {
    const records: RecordedRequest[] = [];
    const transportErrors: Error[] = [];
...
export async function clientTransportHttpResumeStreamApi(_args: TestArgs) {
    const records: RecordedRequest[] = [];
...
export async function clientTransportHttpBodyStreamErrorPreserved(_args: TestArgs) {
...
export async function clientTransportHttpSession404Reinitialize(_args: TestArgs) {
    const records: RecordedRequest[] = [];
    const handle = hostPerSession(() => echoServer());
    let sessionIdToBreak: string | undefined;
