...
export async function resourcesListBasic({ transport }: TestArgs) {
    const makeServer = () => {
...
export async function resourcesListPagination({ transport }: TestArgs) {
    const TOTAL = 25;
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function resourcesListPaginationRaw({ transport }: TestArgs) {
    const TOTAL = 25;
    const PAGE = 10;
...
export async function resourcesReadText({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function resourcesReadBlob({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function resourcesReadUnknownUri({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function resourcesReadTemplateVars({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        s.registerResource(
            'greet',
...
export async function resourcesListChanged({ transport }: TestArgs) {
...
export async function resourcesAnnotations({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        s.registerResource(
            'annotated',
...
export async function resourcesCapabilityDeclared({ transport }: TestArgs) {
    const makeServer = () => {
...
export async function resourcesSubscribeCapabilityRequired({ transport }: TestArgs) {
    const makeServer = () => {
...
export async function resourcesSubscribeUpdated({ transport }: TestArgs) {
    let server!: Server;
...
export async function resourcesUnsubscribeStopsUpdates({ transport }: TestArgs) {
    let server!: Server;
    const subscriptions = new Set<string>();
    const makeServer = () => {
        server = new Server({ name: 's', version: '0' }, { capabilities: { resources: { listChanged: true, subscribe: true } } });
...
export async function resourcesTemplatesList({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        s.registerResource(
            'greet',
...
export async function resourcesTemplatesPagination({ transport }: TestArgs) {
    const TOTAL = 25;
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        for (let i = 0; i < TOTAL; i++) {
...
export async function resourcesTemplatesPaginationRaw({ transport }: TestArgs) {
    const TOTAL = 25;
    const PAGE = 10;
...
export async function mcpserverResourceDuplicateName({ transport }: TestArgs) {
    let server!: McpServer;
    const makeServer = () => {
        server = new McpServer({ name: 's', version: '0' });
...
export async function mcpserverResourceHandleUpdateRemove({ transport }: TestArgs) {
...
export async function mcpserverResourceReadThrowsSurfaced({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function mcpserverResourceTemplateListCallback({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function mcpserverResourceMetadataOverride({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        s.registerResource(
            'listed',
...
export async function mcpserverResourceLegacyOverload({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
