...
export async function transportStdioCleanShutdown(_args: TestArgs) {
...
export async function transportStdioNoEmbeddedNewlines(_args: TestArgs) {
    const payload = [
        'first line',
...
export async function transportStdioShutdownEscalation(_args: TestArgs) {
...
export async function transportStdioStderrPassthrough(_args: TestArgs) {
...
export async function lifecycleConnectOnerrorPreHandshake(_args: TestArgs) {
...
export async function transportStdioDefaultEnvSafelist(_args: TestArgs) {
