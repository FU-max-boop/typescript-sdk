...
export async function toolsCallContentText({ transport }: TestArgs) {
...
export async function toolsCallContentImage({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function toolsCallContentAudio({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function toolsCallContentEmbeddedResource({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function toolsCallContentResourceLink({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function toolsCallContentMixed({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function toolsCallSamplingRoundtrip({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function toolsCallElicitationRoundtrip({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function toolsCallLoggingMidExecution({ transport }: TestArgs) {
    const makeServer = () => {
...
export async function toolsCallProgress({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function toolsCallIsError({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function toolsCallUnknownName({ transport }: TestArgs) {
...
export async function toolsCallUnknownNameRaw({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new Server({ name: 's', version: '0' }, { capabilities: { tools: {} } });
        s.setRequestHandler(ListToolsRequestSchema, () => ({
...
export async function toolsCallStructuredContent({ transport }: TestArgs) {
    const client = newClient();
...
export async function toolsCallStructuredContentTextMirror({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, schemaServer, client);
...
export async function clientOutputSchemaValidateRaw({ transport }: TestArgs) {
...
export async function clientOutputSchemaSkipOnError({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, schemaServer, client);
...
export async function mcpserverOutputSchemaServerValidate({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, schemaServer, client);
...
export async function mcpserverOutputSchemaMissingStructured({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, schemaServer, client);
...
export async function mcpserverOutputSchemaSkipOnError({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, schemaServer, client);
...
export async function toolsListBasic({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        s.registerTool(
            'echo',
...
export async function toolsListMetadataRaw({ transport }: TestArgs) {
...
export async function toolsListPagination({ transport }: TestArgs) {
    const TOTAL = 25;
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function toolsListPaginationRaw({ transport }: TestArgs) {
    const TOTAL = 25;
    const PAGE = 10;
...
export async function toolsListChanged({ transport }: TestArgs) {
...
export async function toolsCapabilityDeclared({ transport }: TestArgs) {
    const makeServer = () => {
...
export async function toolsInputSchemaJsonSchema202012Raw({ transport }: TestArgs) {
    const client = newClient();
...
export async function toolsInputSchemaPreserveDefsRaw({ transport }: TestArgs) {
    const client = newClient();
    await using _ = await wire(transport, rawJsonSchemaServer, client);
...
export async function toolsInputSchemaPreserveSchemaDialectRaw({ transport }: TestArgs) {
...
export async function toolsInputSchemaPreserveAdditionalPropertiesRaw({ transport }: TestArgs) {
...
export async function mcpserverToolHandlerThrows({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function mcpserverToolDuplicateName({ transport }: TestArgs) {
...
export async function mcpserverToolHandleUpdate({ transport }: TestArgs) {
...
export async function mcpserverToolInputValidation({ transport }: TestArgs) {
...
export async function mcpserverToolNamingValidation({ transport }: TestArgs) {
...
export async function mcpserverToolUrlElicitationError({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
...
export async function mcpserverToolZodVariants({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        s.registerTool(
            'zod-union',
...
export async function mcpserverToolExtra({ transport }: TestArgs) {
...
export async function clientCallToolCompatResultSchemaRaw({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new Server({ name: 's', version: '0' }, { capabilities: { tools: {} } });
        s.setRequestHandler(ListToolsRequestSchema, () => ({
...
export async function mcpserverToolVariadicForms({ transport }: TestArgs) {
    const makeServer = () => {
        const s = new McpServer({ name: 's', version: '0' });
        // (name, cb)
